...
envs = {
  API_BASE_URL                = "https://lfi6kctke3.execute-api.us-east-1.amazonaws.com/dev"
  ASSISTANTS_API_BASE         = "https://lfi6kctke3.execute-api.us-east-1.amazonaws.com/dev/assistants"
  ...
  CHAT_ENDPOINT               = "https://czeie7zw6fqm5aluomppaebjwm0fzaig.lambda-url.us-east-1.on.aws/"
  COGNITO_CLIENT_ID           = "7umr7ec3vpj9qbjnu9tre02kfk"
  COGNITO_DOMAIN              = "https://dev-amplifygenai-userpool-ptgpi71c.auth.us-east-1.amazoncognito.com"
  COGNITO_ISSUER              = "https://cognito-idp.us-east-1.amazonaws.com/us-east-1_oTOneBRP5"
  DEFAULT_MODEL               = "anthropic.claude-3-haiku-20240307-v1:0"
  DEFAULT_FUNCTION_CALL_MODEL = "gpt-4-1106-Preview" # Deprecated
  MIXPANEL_TOKEN              = ""
  NEXTAUTH_SECRET             = "EuRYdIjIRMa8W1kPR/Rmz6thW6D13CgOZf0csMPu7qM="
  NEXTAUTH_URL                = "https://dev-amplifygenai-alb-1326930782.us-east-1.elb.amazonaws.com"
